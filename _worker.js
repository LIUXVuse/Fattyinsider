...
const PODCAST_KEYWORDS = [
  's3ep', '哪一集', '節目', '老雞', '依依', '老師', '若隱', '打賽', '立舒', '比爾',
  '回聽', '講過', '分享', '錄音', '摘要', '推薦集數', '哪一集講', '來賓', '特派',
  '節目有提到', '說過', '哪一集說', '集數', '藍甲蟲', 'kc', '龍津', '悠君', '老王', '老張',
  '竹科小瓢蟲', '小瓢蟲', '力書', '八爺', '巴爺', '阿祖', '阿姆', '克里斯', 'ken', 'lasai',
  '主持人', '聽眾來信', '提到', '回顧', '群組', '節目有說', '這集', '幹部', '音檔',
  '片頭', '片尾', '小編', '留言', '互動房', '素材', '錄起來', '節目裡'
];
